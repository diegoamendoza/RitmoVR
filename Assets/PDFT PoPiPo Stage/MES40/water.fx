...
#define NormalMapTexture  "F_DIVA_STGD2NS057_HR_BMP_000.png"

	#define Toon_Use_NormalMap 1
	#define Spa_CubeMap_Use_NormalMap 1
	#define SpecularLight_Use_NormalMap 1
	
	float NormalMap_Intensity = 0.8;
	#define NormalMap_Animated 1
	
//#define SpecularMapTexture  "F_DIVA_STGD2NS057_NK_YUKAN_S.png"
...
#define CubeMapTexture "F_DIVA_STGD2NS057_HR_ENV01.dds"
...
float Spa_CubeMap_Intensity = 1.5;
...
//If you have a problem of the lighting having seams, you can use cubemap making programs like CubeMapGen to down-sample the cubemap directly, and not rely on IBL_Resolution
	...
	float IBL_Brightness = 1.2;
	float IBL_Saturation = 1;
	float IBL_Blur = 10;
	
	#define IBL_Resolution 0.2
