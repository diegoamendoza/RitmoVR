...
//#define NormalMapTexture  "F_DIVA_STGD2NS057_NK_STAGES_N.png"
...
#define SUBMAP 1
	...
	#define SubMapTexture "F_DIVA_STGD2NS057_NK_TRAIN_SDW2.png"
...
//If you have a problem of the lighting having seams, you can use cubemap making programs like CubeMapGen to down-sample the cubemap directly, and not rely on IBL_Resolution
	...
	float IBL_Intensity = 1.5;
	float IBL_Brightness = 1.3;
	float IBL_Saturation = 0.3;
	float IBL_Blur = 10;
